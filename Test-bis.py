...
#'''================================================================================================='''
       ...
       #son_base3.stop()
        ...
        afficheScore = screen.subsurface(350,250,500,600)
        ...
        policeScore = pygame.font.Font(None, 12) # la police utilisée pour afficher le score   
       ...
       #  Boucle principale du jeu   
        while windows==1 and tabloJeu.gameOver==False:
            ...
            textScore = policeScore.render(('[%s]' % '\n'.join(map(str, afficheTableau))), False, (0,0,0))
            screen.fill(CONST.BLANC)
            afficheScore.blit(textScore, (0,0))
